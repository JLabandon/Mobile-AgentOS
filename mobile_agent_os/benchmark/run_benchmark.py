...
from ..runtimes import AsyncSingleDisplayRuntime, ResidentRuntime, StewardSerialRuntime
...
RUNTIME_CLASSES = {
    ...
    "async_single_display": AsyncSingleDisplayRuntime,
...
def run_once(
    *,
    ...
    try:
        ...
        task_plans = load_task_plans(suite_path, runtime=runtime_name)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.runtimes:
        ...
        runtime_names = ["async_single_display"]
